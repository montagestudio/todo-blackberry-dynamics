...
module.exports = function(context) {
    ...
    // Remove Simulation mode preference from config.xml 
    var preferenceForRemove = ['GDEnterpriseSimulationMode', 'GDApplicationID', 'GDApplicationVersion', 'BBD_Enterprise_Discovery'];
